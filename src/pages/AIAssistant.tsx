...
export default function AIAssistant() {
  ...
  return (
    <div className="h-[calc(100vh-140px)] max-w-5xl mx-auto flex flex-col gap-6">
      <header className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
             <h1 className="text-2xl font-bold text-gray-900 leading-none mb-1">AI Risk Assistant</h1>
             <p className="text-gray-500 text-sm">Powered by AquaSense & Gemini AI Explanation Layer</p>
          </div>
        </div>
        <div className="flex bg-white px-3 py-1.5 rounded-full border border-gray-200 shadow-sm items-center gap-2">
           <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse"></div>
           <span className="text-[10px] font-bold text-gray-500 uppercase tracking-widest leading-none">AI Engine Ready</span>
        </div>
      </header>
