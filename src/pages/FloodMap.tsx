  ...
  return (
    <div className="h-[calc(100vh-120px)] flex flex-col gap-6">
      ...
      <header className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div className="space-y-1">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-3xl font-black text-slate-900 tracking-tighter uppercase relative inline-block">
              Live Flood Map
        ...
        <div className="flex flex-wrap items-center gap-4">
           <div className="hidden lg:flex items-center gap-8 border-r border-slate-200 pr-8 mr-2">
           ...
           <div className="relative group">
              ...
              <input 
                ...
                className="pl-10 pr-4 py-3 bg-white border border-slate-200 rounded-2xl text-[11px] font-black uppercase tracking-widest focus:outline-none focus:ring-4 focus:ring-cyan-500/10 focus:border-cyan-500/50 transition-all w-64 shadow-sm"
                value={searchQuery}
      ...
      <div className="flex-1 flex flex-col lg:flex-row gap-6 overflow-hidden">
        ...
        <div className="w-full lg:w-96 flex flex-col gap-6 lg:overflow-y-auto pr-2 scrollbar-hide">
        ...
        {/* The Interactive Map */}
        <div className="flex-1 relative bg-slate-900 rounded-3xl border-2 border-slate-900 overflow-hidden shadow-2xl min-h-[500px]">
           <RealMalaysiaMap 
