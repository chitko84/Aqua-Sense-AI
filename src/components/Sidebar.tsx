...
export default function Sidebar() {
  ...
  return (
    <aside className="w-64 bg-slate-900 text-white flex flex-col h-screen fixed left-0 top-0 z-40 border-r border-slate-800 shadow-[20px_0_60px_-15px_rgba(0,0,0,0.3)]">
      ...
      <nav className="flex-1 px-5 space-y-10 overflow-y-auto pb-10 scrollbar-hide">
        <div>
